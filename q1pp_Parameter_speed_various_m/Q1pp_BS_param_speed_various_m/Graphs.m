...
for itt=1:NumberOfColumns
    ...
    load_string = sprintf('q1pp_bs_parameter_speed_m=%u_%u',mm1,mm);
    mm = mm + 1;
    if(mm>9)
        mm = 0;
        mm1 = mm1+1;
...
title('Ride quality factor by BS 6841 at mass center (q1pp)','fontsize',9,'fontweight','b','color','black');
ylabel('RMS by BS 6841','fontsize',9,'fontweight','b','color','black');
