...
%----------------------DEFAULT CASE ---------------------------------------
    ...
    grid on;
    ylabel('Ride index comfort value (Sperling Wz)','fontsize',9,'fontweight','b','color','black');
    %damper coefficient parametrization file is read
    if(select_param == 1)
        xlabel('Damping coefficient in mm ','fontsize',9,'fontweight','b','color','black');
    ...
    grid on;
    ylabel('Ride quality factor (Sperling Wr)','fontsize',9,'fontweight','b','color','black');
    %damper coefficient parametrization file is read
    if(select_param == 1)
        xlabel('Damping coefficient in mm ','fontsize',9,'fontweight','b','color','black');
        title_str = sprintf('Ride quality factor by Sperling (speed V = %um/s)',file_params(4));
        title(title_str,'fontsize',9,'fontweight','b','color','black');
    %speed parametrization file is read
    elseif(2 == select_param)
        xlabel('Speed V in m/s');
